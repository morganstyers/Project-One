    ...
    function showPosition(position) {
      ...
      var queryurl = "http://beermapping.com/webservice/locquery/1fa557925657b372c844342cf9a40f37/" + name
       ...
       $.ajax({ 
         url: queryurl, 
         method: "GET", 
         //"headers": { "Authorization": "Bearer cycx3mtFkOQeQ1bqEXUg_25bMQ5oPNvpF554EnE87a8YVWOQs9yXy0-61ZsFOi7v0_GqqkT07ij0PpKlUnKzfe396NQmdDJrWvbi8BhnTkoRVuyJb5VPziQbz8ZzXXYx", } 
        })
        .then(function (response) { 
